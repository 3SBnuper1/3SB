------------------------------------------------
-- This Source Was Developed By (3SAB) @e_h_t.--
--   This Is The Source Channel @e_h_t .   --
--                - 3 𝐒 𝐀 𝐁 ♕-                 --
--        -- https://t.me/k_e_r --         --
------------------------------------------------ 
...
local UserId_Info = LuaTele.searchPublicChat("k_e_r")
...
{
{text = 'Developer Source !', url = 't.me/k_e_r'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
return LuaTele.sendText(msg_chat_id,msg_id,'*تـدوم عم?يي?? ?*',"md",false, false, false, false, reply_markup)
end
if text == '??' or text == '??' then
if not Redis:get(The3SAB.."3SAB:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'* شـبي حـلـو صـافـن???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*امـشي وخ? مـنـا يدو? تـ?ـبيل?? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*شـعلي? بـي عم?يي خـلي يـزحف???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*اسـف عم?يي مـا خلي? بـحـل?ي???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*زاحـف ع خـالـ? شـ??ه???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*امـشـي? بـيها عم?يي???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*ويـنـه بـلـه خـل حـصـ?ه???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*هااا يـول اخـذتـها خـاص???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عـساس انـي مـيـت بي?? دمـشـي ل????? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*يـحـياتـي وانـي هـم حـبـ???????*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*ويـن دايـح عم?يي خـلـينـا مـونـسـيـن?????*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*حـبيـبي ولله ?بـط فـيـشه ويـانـا???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*شـغال عم?يي???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عم?يي تـفـضل ويا? مـديـ????*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*صـا? عم?يي???? ?*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*سـؤال صـعـب خلـيـني اف?????*',"md",false, false, false, false, reply_markup)
end
if text == 'تحديث' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*??هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
...
if text == (Redis:get(The3SAB.."3SAB:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(The3SAB.."3SAB:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أ?? أ?? هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n??أهلآ بك في بوت '..(Redis:get(The3SAB.."3SAB:Name:Bot") or "بلاك بينك")..
...
data = {
{
{text = '? السورس .', url = 't.me/ieeo3s'},{text = '? لتنصيب بوت .', url = 't.me/k_e_r'}, 
},
{
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`????´', data =UserId..'/'.. 'listallAddorrem'},},}}
